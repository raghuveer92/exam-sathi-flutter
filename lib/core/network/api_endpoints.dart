...
class ApiEndpoints {
  ...
  static String examSubjectGroups(int examId) =>
      '/student/exams/$examId/subject-groups';
  static String myExamDate(int userExamId) =>
      '/student/my-exams/$userExamId/date';
  static String setActiveMyExam(int userExamId) =>
      '/student/my-exams/$userExamId/active';
  static String deleteMyExam(int userExamId) => '/student/my-exams/$userExamId';
  static String subjectSelections(int userExamId) =>
      '/student/my-exams/$userExamId/subject-selections';
  ...
  static const String reminderPreference = '/progress/reminder-preference';
  static const String noStudyDay = '/progress/no-study-day';
  ...
  // Mock Tests
  static String mockTestTopicInfo(int topicId) =>
      '/mock-tests/topics/$topicId/info';
  static String mockTestStart(int topicId) =>
      '/mock-tests/topics/$topicId/start';
  static String mockTestAttempts(int topicId) =>
      '/mock-tests/topics/$topicId/attempts';
  static String mockTestSubmit(int attemptId) =>
      '/mock-tests/attempts/$attemptId/submit';
  static String mockTestAttempt(int attemptId) =>
  ...
  static String sheetTopicStart(int topicId) =>
      '/mock/topic/start?topicId=$topicId';
  static const String sheetTopicSubmit = '/mock/topic/submit';
  static String sheetTopicResult(int attemptId) =>
      '/mock/topic/result?attemptId=$attemptId';
  static String sheetTopicMastery(int topicId) =>
      '/mock/topic/mastery?topicId=$topicId';
